  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-shrink-0">
        <div className="bg-black text-white px-4 py-2 text-[13px] font-bold uppercase inline-block">
          Новости
        </div>
        <div className="border-t-[3px] border-black w-full mt-0"></div>
      </div>

      <div className="flex flex-col gap-0 mt-3 flex-grow">
        {news.map((item) => (
          <div key={item.id} className="py-3 border-b border-gray-100 group cursor-pointer flex gap-3 items-start">
            <div className="mt-[7px] w-[5px] h-[5px] rounded-full bg-gray-300 flex-shrink-0 group-hover:bg-brand-orange transition-colors"></div>
            <h3 
