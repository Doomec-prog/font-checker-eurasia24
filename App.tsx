...
const App: React.FC = () => {
  ...
  // The user prompt requests Inter, Source Serif, etc. defaulting to one.
    ...
    >
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-6 order-1 lg:order-2 border-r-0 lg:border-r border-gray-100 pr-0 lg:pr-8">
            <MainStory article={MAIN_ARTICLE} />
          </div>

          {/* Right Column: News Feed */}
          <div className="lg:col-span-3 order-3 border-l-0 lg:border-l border-gray-100 pl-0 lg:pl-8">
